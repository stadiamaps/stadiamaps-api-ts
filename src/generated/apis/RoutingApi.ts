...
export class RoutingApi extends runtime.BaseAPI {
  /**
   * Creates request options for isochrone without sending the request
   */
  async isochroneRequestOpts(
  ...
  async isochroneRaw(
    ...
    const requestOptions = await this.isochroneRequestOpts(requestParameters);
  ...
  /**
   * Creates request options for mapMatch without sending the request
   */
  async mapMatchRequestOpts(
  ...
  async mapMatchRaw(
    ...
    const requestOptions = await this.mapMatchRequestOpts(requestParameters);
    const response = await this.request(requestOptions, initOverrides);
  ...
  /**
   * Creates request options for nearestRoads without sending the request
   */
  async nearestRoadsRequestOpts(
  ...
  async nearestRoadsRaw(
    ...
    const requestOptions =
      await this.nearestRoadsRequestOpts(requestParameters);
    const response = await this.request(requestOptions, initOverrides);
  ...
  /**
   * Creates request options for optimizedRoute without sending the request
   */
  async optimizedRouteRequestOpts(
    ...
    let urlPath = `/optimized_route/v1`;
  ...
  async optimizedRouteRaw(
    ...
    const requestOptions =
      await this.optimizedRouteRequestOpts(requestParameters);
    const response = await this.request(requestOptions, initOverrides);
  ...
  /**
   * Creates request options for route without sending the request
   */
  async routeRequestOpts(
  ...
  async routeRaw(
    ...
    const requestOptions = await this.routeRequestOpts(requestParameters);
    const response = await this.request(requestOptions, initOverrides);
  ...
  /**
   * Creates request options for timeDistanceMatrix without sending the request
   */
  async timeDistanceMatrixRequestOpts(
  ...
  async timeDistanceMatrixRaw(
    ...
    const requestOptions =
      await this.timeDistanceMatrixRequestOpts(requestParameters);
    const response = await this.request(requestOptions, initOverrides);
  ...
  /**
   * Creates request options for traceAttributes without sending the request
   */
  async traceAttributesRequestOpts(
    ...
    let urlPath = `/trace_attributes/v1`;
  ...
  async traceAttributesRaw(
    ...
    const requestOptions =
      await this.traceAttributesRequestOpts(requestParameters);
    const response = await this.request(requestOptions, initOverrides);
