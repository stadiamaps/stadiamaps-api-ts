...
export class GeocodingApi extends runtime.BaseAPI {
     ...
     */
    async searchBulkRaw(requestParameters: SearchBulkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<BulkSearchResponse>>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(BulkSearchResponseFromJSON));
    }
     ...
     * Quickly run a batch of geocoding queries against the search or structured search endpoints.
     */
    async searchBulk(requestParameters: SearchBulkRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<BulkSearchResponse>> {
