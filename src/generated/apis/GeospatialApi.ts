...
export class GeospatialApi extends runtime.BaseAPI {
    ...
    async elevationRaw(requestParameters: ElevationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HeightResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => HeightResponseFromJSON(jsonValue));
    }
     ...
     */
    async tzLookupRaw(requestParameters: TzLookupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TzResponse>> {
        if (requestParameters.lat === null || requestParameters.lat === undefined) {
            throw new runtime.RequiredError('lat','Required parameter requestParameters.lat was null or undefined when calling tzLookup.');
        }

        if (requestParameters.lng === null || requestParameters.lng === undefined) {
            throw new runtime.RequiredError('lng','Required parameter requestParameters.lng was null or undefined when calling tzLookup.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => TzResponseFromJSON(jsonValue));
    }
     ...
     * Get the current time zone information for any point on earth.
     */
    async tzLookup(requestParameters: TzLookupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TzResponse> {
