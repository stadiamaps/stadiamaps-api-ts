...
export interface TraceEdge {
  ...
  /**
   *
   * @type {TraceEdgeVehicleTypeEnum}
   * @memberof TraceEdge
   */
  vehicleType?: TraceEdgeVehicleTypeEnum;
  /**
   *
   * @type {TraceEdgePedestrianTypeEnum}
   * @memberof TraceEdge
   */
  pedestrianType?: TraceEdgePedestrianTypeEnum;
  /**
   *
   * @type {TraceEdgeBicycleTypeEnum}
   * @memberof TraceEdge
   */
  bicycleType?: TraceEdgeBicycleTypeEnum;
  /**
   *
   * @type {TraceEdgeTransitTypeEnum}
   * @memberof TraceEdge
   */
