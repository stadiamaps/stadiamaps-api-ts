 ...
 */
export function instanceOfTruckCostingOptions(value: object): value is TruckCostingOptions {
    return true;
}
...
export function TruckCostingOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TruckCostingOptions {
    if (json == null) {
        return json;
    }
    return {
...
export function TruckCostingOptionsToJSON(value?: TruckCostingOptions | null): any {
    if (value == null) {
        return value;
    }
    return {
