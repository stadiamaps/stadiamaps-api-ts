 ...
 */
export function instanceOfPedestrianCostingOptions(value: object): value is PedestrianCostingOptions {
    return true;
}
...
export function PedestrianCostingOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PedestrianCostingOptions {
    ...
    return {
        ...
        'walkingSpeed': json['walking_speed'] == null ? undefined : json['walking_speed'],
        'walkwayFactor': json['walkway_factor'] == null ? undefined : json['walkway_factor'],
        'sidewalkFactor': json['sidewalk_factor'] == null ? undefined : json['sidewalk_factor'],
        'alleyFactor': json['alley_factor'] == null ? undefined : json['alley_factor'],
        'drivewayFactor': json['driveway_factor'] == null ? undefined : json['driveway_factor'],
        'stepPenalty': json['step_penalty'] == null ? undefined : json['step_penalty'],
        ...
        'maxHikingDifficulty': json['max_hiking_difficulty'] == null ? undefined : json['max_hiking_difficulty'],
        'bssRentCost': json['bss_rent_cost'] == null ? undefined : json['bss_rent_cost'],
        'bssRentPenalty': json['bss_rent_penalty'] == null ? undefined : json['bss_rent_penalty'],
    };
}
