 ...
 */
export function instanceOfRoutingWaypoint(value: object): value is RoutingWaypoint {
...
export function RoutingWaypointFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingWaypoint {
    ...
    return {
        ...
        'headingTolerance': json['heading_tolerance'] == null ? undefined : json['heading_tolerance'],
        'minimumReachability': json['minimum_reachability'] == null ? undefined : json['minimum_reachability'],
        'radius': json['radius'] == null ? undefined : json['radius'],
        'rankCandidates': json['rank_candidates'] == null ? undefined : json['rank_candidates'],
        'preferredSide': json['preferred_side'] == null ? undefined : json['preferred_side'],
        'nodeSnapTolerance': json['node_snap_tolerance'] == null ? undefined : json['node_snap_tolerance'],
        'streetSideTolerance': json['street_side_tolerance'] == null ? undefined : json['street_side_tolerance'],
        'streetSideMaxDistance': json['street_side_max_distance'] == null ? undefined : json['street_side_max_distance'],
        'searchFilter': json['search_filter'] == null ? undefined : RoutingWaypointAllOfSearchFilterFromJSON(json['search_filter']),
    };
}
