 ...
 */
export function instanceOfMotorScooterCostingOptions(value: object): value is MotorScooterCostingOptions {
    return true;
}
...
export function MotorScooterCostingOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MotorScooterCostingOptions {
    ...
    return {
        ...
        'maneuverPenalty': json['maneuver_penalty'] == null ? undefined : json['maneuver_penalty'],
        'gateCost': json['gate_cost'] == null ? undefined : json['gate_cost'],
        'gatePenalty': json['gate_penalty'] == null ? undefined : json['gate_penalty'],
        'countryCrossingCost': json['country_crossing_cost'] == null ? undefined : json['country_crossing_cost'],
        'countryCrossingPenalty': json['country_crossing_penalty'] == null ? undefined : json['country_crossing_penalty'],
        'servicePenalty': json['service_penalty'] == null ? undefined : json['service_penalty'],
        'serviceFactor': json['service_factor'] == null ? undefined : json['service_factor'],
        'useLivingStreets': json['use_living_streets'] == null ? undefined : json['use_living_streets'],
        'useFerry': json['use_ferry'] == null ? undefined : json['use_ferry'],
        'ignoreRestrictions': json['ignore_restrictions'] == null ? undefined : json['ignore_restrictions'],
        'ignoreNonVehicularRestrictions': json['ignore_non_vehicular_restrictions'] == null ? undefined : json['ignore_non_vehicular_restrictions'],
        'ignoreOneways': json['ignore_oneways'] == null ? undefined : json['ignore_oneways'],
        'height': json['height'] == null ? undefined : json['height'],
        'width': json['width'] == null ? undefined : json['width'],
        'tollBoothCost': json['toll_booth_cost'] == null ? undefined : json['toll_booth_cost'],
        'tollBoothPenalty': json['toll_booth_penalty'] == null ? undefined : json['toll_booth_penalty'],
        'ferryCost': json['ferry_cost'] == null ? undefined : json['ferry_cost'],
        'useHighways': json['use_highways'] == null ? undefined : json['use_highways'],
        ...
        'ignoreClosures': json['ignore_closures'] == null ? undefined : json['ignore_closures'],
        'includeHov2': json['include_hov2'] == null ? undefined : json['include_hov2'],
        'includeHov3': json['include_hov3'] == null ? undefined : json['include_hov3'],
        'includeHot': json['include_hot'] == null ? undefined : json['include_hot'],
        'alleyFactor': json['alley_factor'] == null ? undefined : json['alley_factor'],
