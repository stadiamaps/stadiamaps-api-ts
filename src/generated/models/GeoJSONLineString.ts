...
export function GeoJSONLineStringToJSON(json: any): GeoJSONLineString {
  return GeoJSONLineStringToJSONTyped(json, false);
}

export function GeoJSONLineStringToJSONTyped(
