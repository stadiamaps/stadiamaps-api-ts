...
export function MatchedPointFromJSONTyped(json: any, ignoreDiscriminator: boolean): MatchedPoint {
    ...
    return {
        ...
        'beginRouteDiscontinuity': json['begin_route_discontinuity'] == null ? undefined : json['begin_route_discontinuity'],
        'endRouteDiscontinuity': json['end_route_discontinuity'] == null ? undefined : json['end_route_discontinuity'],
        'distanceAlongEdge': json['distance_along_edge'] == null ? undefined : json['distance_along_edge'],
        'distanceFromTracePoint': json['distance_from_trace_point'] == null ? undefined : json['distance_from_trace_point'],
    };
}
