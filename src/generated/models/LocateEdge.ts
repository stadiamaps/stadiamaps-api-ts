...
export function instanceOfLocateEdge(value: object): value is LocateEdge {
    if (!('correlatedLat' in value) || value['correlatedLat'] === undefined) return false;
    if (!('correlatedLon' in value) || value['correlatedLon'] === undefined) return false;
    if (!('percentAlong' in value) || value['percentAlong'] === undefined) return false;
    if (!('sideOfStreet' in value) || value['sideOfStreet'] === undefined) return false;
    return true;
}
...
export function LocateEdgeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocateEdge {
    ...
    return {
        ...
        'edgeId': json['edge_id'] == null ? undefined : NodeIdFromJSON(json['edge_id']),
        ...
        'linearReference': json['linear_reference'] == null ? undefined : json['linear_reference'],
        'outboundReach': json['outbound_reach'] == null ? undefined : json['outbound_reach'],
        'heading': json['heading'] == null ? undefined : json['heading'],
        'inboundReach': json['inbound_reach'] == null ? undefined : json['inbound_reach'],
        'distance': json['distance'] == null ? undefined : json['distance'],
        'predictedSpeeds': json['predicted_speeds'] == null ? undefined : json['predicted_speeds'],
        'edgeInfo': json['edge_info'] == null ? undefined : LocateEdgeInfoFromJSON(json['edge_info']),
        'edge': json['edge'] == null ? undefined : LocateDetailedEdgeFromJSON(json['edge']),
