 ...
 */
export function instanceOfBulkSearchResponse(value: object): value is BulkSearchResponse {
...
export function BulkSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BulkSearchResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'status': json['status'],
        'response': json['response'] == null ? undefined : PeliasResponseFromJSON(json['response']),
        'msg': json['msg'] == null ? undefined : json['msg'],
    };
}

export function BulkSearchResponseToJSON(value?: BulkSearchResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
