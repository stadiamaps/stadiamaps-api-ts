 ...
 */
export function instanceOfTraceAttributesResponse(value: object): value is TraceAttributesResponse {
    return true;
}
...
export function TraceAttributesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TraceAttributesResponse {
    ...
    return {
        ...
        'units': json['units'] == null ? undefined : ValhallaLongUnitsFromJSON(json['units']),
        'alternatePaths': json['alternate_paths'] == null ? undefined : ((json['alternate_paths'] as Array<any>).map(TraceAttributesBaseResponseFromJSON)),
    };
}
...
export function TraceAttributesResponseToJSON(value?: TraceAttributesResponse | null): any {
    ...
    return {
        ...
        'alternate_paths': value['alternatePaths'] == null ? undefined : ((value['alternatePaths'] as Array<any>).map(TraceAttributesBaseResponseToJSON)),
    };
}
