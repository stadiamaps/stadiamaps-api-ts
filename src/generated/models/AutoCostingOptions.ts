 ...
 */
export function instanceOfAutoCostingOptions(value: object): value is AutoCostingOptions {
    return true;
}
...
export function AutoCostingOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutoCostingOptions {
    if (json == null) {
        return json;
    }
    return {
...
export function AutoCostingOptionsToJSON(value?: AutoCostingOptions | null): any {
    if (value == null) {
        return value;
    }
    return {
