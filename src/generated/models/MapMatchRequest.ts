 ...
 */
export function instanceOfMapMatchRequest(value: object): value is MapMatchRequest {
...
export function MapMatchRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): MapMatchRequest {
    ...
    return {
        ...
        'useTimestamps': json['use_timestamps'] == null ? undefined : json['use_timestamps'],
        'traceOptions': json['trace_options'] == null ? undefined : MapMatchTraceOptionsFromJSON(json['trace_options']),
        'linearReferences': json['linear_references'] == null ? undefined : json['linear_references'],
    };
}
