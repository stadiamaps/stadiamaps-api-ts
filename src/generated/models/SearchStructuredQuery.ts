 ...
 */
export function instanceOfSearchStructuredQuery(value: object): value is SearchStructuredQuery {
    return true;
}

export function SearchStructuredQueryFromJSON(json: any): SearchStructuredQuery {
    return SearchStructuredQueryFromJSONTyped(json, false);
}

export function SearchStructuredQueryFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchStructuredQuery {
    if (json == null) {
        return json;
    }
    return {
        ...
        'focusPointLat': json['focus.point.lat'] == null ? undefined : json['focus.point.lat'],
        'focusPointLon': json['focus.point.lon'] == null ? undefined : json['focus.point.lon'],
        'boundaryRectMinLat': json['boundary.rect.min_lat'] == null ? undefined : json['boundary.rect.min_lat'],
        'boundaryRectMaxLat': json['boundary.rect.max_lat'] == null ? undefined : json['boundary.rect.max_lat'],
        'boundaryRectMinLon': json['boundary.rect.min_lon'] == null ? undefined : json['boundary.rect.min_lon'],
        'boundaryRectMaxLon': json['boundary.rect.max_lon'] == null ? undefined : json['boundary.rect.max_lon'],
        'boundaryCircleLat': json['boundary.circle.lat'] == null ? undefined : json['boundary.circle.lat'],
        'boundaryCircleLon': json['boundary.circle.lon'] == null ? undefined : json['boundary.circle.lon'],
        'boundaryCircleRadius': json['boundary.circle.radius'] == null ? undefined : json['boundary.circle.radius'],
        'boundaryCountry': json['boundary.country'] == null ? undefined : json['boundary.country'],
        'boundaryGid': json['boundary.gid'] == null ? undefined : json['boundary.gid'],
        'layers': json['layers'] == null ? undefined : ((json['layers'] as Array<any>).map(PeliasLayerFromJSON)),
        'sources': json['sources'] == null ? undefined : ((json['sources'] as Array<any>).map(PeliasSourceFromJSON)),
        'size': json['size'] == null ? undefined : json['size'],
        'lang': json['lang'] == null ? undefined : json['lang'],
    };
}

export function SearchStructuredQueryToJSON(value?: SearchStructuredQuery | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'layers': value['layers'] == null ? undefined : ((value['layers'] as Array<any>).map(PeliasLayerToJSON)),
        'sources': value['sources'] == null ? undefined : ((value['sources'] as Array<any>).map(PeliasSourceToJSON)),
        'size': value['size'],
        'lang': value['lang'],
    };
}
