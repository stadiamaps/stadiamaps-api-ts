 ...
 */
export function instanceOfRoutingResponseWaypoint(value: object): value is RoutingResponseWaypoint {
...
export function RoutingResponseWaypointFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingResponseWaypoint {
    ...
    return {
        ...
        'originalIndex': json['original_index'] == null ? undefined : json['original_index'],
    };
}
