...
export function LocateNodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocateNode {
    ...
    return {
        ...
        'nodeId': json['node_id'] == null ? undefined : NodeIdFromJSON(json['node_id']),
        'access': json['access'] == null ? undefined : AccessFromJSON(json['access']),
        'edgeCount': json['edge_count'] == null ? undefined : json['edge_count'],
        'administrative': json['administrative'] == null ? undefined : AdministrativeFromJSON(json['administrative']),
        'intersectionType': json['intersection_type'] == null ? undefined : json['intersection_type'],
        'density': json['density'] == null ? undefined : json['density'],
        'localEdgeCount': json['local_edge_count'] == null ? undefined : json['local_edge_count'],
