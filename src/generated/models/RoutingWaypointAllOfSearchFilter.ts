 ...
 */
export function instanceOfRoutingWaypointAllOfSearchFilter(value: object): value is RoutingWaypointAllOfSearchFilter {
    return true;
}
...
export function RoutingWaypointAllOfSearchFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingWaypointAllOfSearchFilter {
    ...
    return {
        ...
        'excludeTunnel': json['exclude_tunnel'] == null ? undefined : json['exclude_tunnel'],
        'excludeBridge': json['exclude_bridge'] == null ? undefined : json['exclude_bridge'],
        'excludeRamp': json['exclude_ramp'] == null ? undefined : json['exclude_ramp'],
        'excludeClosures': json['exclude_closures'] == null ? undefined : json['exclude_closures'],
        'minRoadClass': json['min_road_class'] == null ? undefined : RoadClassFromJSON(json['min_road_class']),
        'maxRoadClass': json['max_road_class'] == null ? undefined : RoadClassFromJSON(json['max_road_class']),
    };
}
