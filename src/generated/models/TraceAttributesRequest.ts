 ...
 */
export function instanceOfTraceAttributesRequest(value: object): value is TraceAttributesRequest {
...
export function TraceAttributesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TraceAttributesRequest {
    ...
    return {
        ...
        'filters': json['filters'] == null ? undefined : TraceAttributeFilterOptionsFromJSON(json['filters']),
    };
}
