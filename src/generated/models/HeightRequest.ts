...
export function HeightRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): HeightRequest {
    ...
    return {
        ...
        'shape': json['shape'] == null ? undefined : ((json['shape'] as Array<any>).map(CoordinateFromJSON)),
        'encodedPolyline': json['encoded_polyline'] == null ? undefined : json['encoded_polyline'],
        'shapeFormat': json['shape_format'] == null ? undefined : json['shape_format'],
        'range': json['range'] == null ? undefined : json['range'],
        'heightPrecision': json['height_precision'] == null ? undefined : json['height_precision'],
        'resampleDistance': json['resample_distance'] == null ? undefined : json['resample_distance'],
    };
}
...
export function HeightRequestToJSON(value?: HeightRequest | null): any {
    ...
    return {
        ...
        'id': value['id'],
        'shape': value['shape'] == null ? undefined : ((value['shape'] as Array<any>).map(CoordinateToJSON)),
