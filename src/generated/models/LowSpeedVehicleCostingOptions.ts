 ...
 */
export function instanceOfLowSpeedVehicleCostingOptions(value: object): value is LowSpeedVehicleCostingOptions {
    return true;
}

export function LowSpeedVehicleCostingOptionsFromJSON(json: any): LowSpeedVehicleCostingOptions {
    return LowSpeedVehicleCostingOptionsFromJSONTyped(json, false);
}

export function LowSpeedVehicleCostingOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LowSpeedVehicleCostingOptions {
    if (json == null) {
        return json;
    }
    return {
        ...
        'maxAllowedSpeedLimit': json['max_allowed_speed_limit'] == null ? undefined : json['max_allowed_speed_limit'],
    };
}

export function LowSpeedVehicleCostingOptionsToJSON(value?: LowSpeedVehicleCostingOptions | null): any {
    if (value == null) {
        return value;
    }
    return {
