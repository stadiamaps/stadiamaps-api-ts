 ...
 */
export function instanceOfLocateDetailedEdge(value: object): value is LocateDetailedEdge {
    return true;
}
...
export function LocateDetailedEdgeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocateDetailedEdge {
    ...
    return {
        ...
        'sidewalkLeft': json['sidewalk_left'] == null ? undefined : json['sidewalk_left'],
        'sidewalkRight': json['sidewalk_right'] == null ? undefined : json['sidewalk_right'],
        ...
        'endNode': json['end_node'] == null ? undefined : NodeIdFromJSON(json['end_node']),
        'truckRoute': json['truck_route'] == null ? undefined : json['truck_route'],
        'speeds': json['speeds'] == null ? undefined : SpeedsFromJSON(json['speeds']),
        'bikeNetwork': json['bike_network'] == null ? undefined : json['bike_network'],
        'roundAbout': json['round_about'] == null ? undefined : json['round_about'],
        'trafficSignal': json['traffic_signal'] == null ? undefined : json['traffic_signal'],
        'accessRestriction': json['access_restriction'] == null ? undefined : json['access_restriction'],
        'destinationOnly': json['destination_only'] == null ? undefined : json['destination_only'],
        'geoAttributes': json['geo_attributes'] == null ? undefined : GeoAttributesFromJSON(json['geo_attributes']),
        'startRestriction': json['start_restriction'] == null ? undefined : RestrictionsFromJSON(json['start_restriction']),
        'cycleLane': json['cycle_lane'] == null ? undefined : json['cycle_lane'],
        'endRestriction': json['end_restriction'] == null ? undefined : RestrictionsFromJSON(json['end_restriction']),
        'seasonal': json['seasonal'] == null ? undefined : json['seasonal'],
        'countryCrossing': json['country_crossing'] == null ? undefined : json['country_crossing'],
        'partOfComplexRestriction': json['part_of_complex_restriction'] == null ? undefined : json['part_of_complex_restriction'],
        'hasSign': json['has_sign'] == null ? undefined : json['has_sign'],
        'access': json['access'] == null ? undefined : RestrictionsFromJSON(json['access']),
        'bridge': json['bridge'] == null ? undefined : json['bridge'],
        'classification': json['classification'] == null ? undefined : HighwayClassificationFromJSON(json['classification']),
