 ...
 */
export function instanceOfPeliasGeoJSONProperties(value: object): value is PeliasGeoJSONProperties {
    return true;
}
...
export function PeliasGeoJSONPropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PeliasGeoJSONProperties {
    ...
    return {
        ...
        'layer': json['layer'] == null ? undefined : PeliasLayerFromJSON(json['layer']),
        'name': json['name'] == null ? undefined : json['name'],
        'accuracy': json['accuracy'] == null ? undefined : json['accuracy'],
        'addendum': json['addendum'] == null ? undefined : PeliasGeoJSONPropertiesAddendumFromJSON(json['addendum']),
        'continent': json['continent'] == null ? undefined : json['continent'],
        'continentGid': json['continent_gid'] == null ? undefined : json['continent_gid'],
        ...
        'neighbourhoodGid': json['neighbourhood_gid'] == null ? undefined : json['neighbourhood_gid'],
        ...
        'localityGid': json['locality_gid'] == null ? undefined : json['locality_gid'],
