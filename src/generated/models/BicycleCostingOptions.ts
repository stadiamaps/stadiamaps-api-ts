 ...
 */
export function instanceOfBicycleCostingOptions(value: object): value is BicycleCostingOptions {
    return true;
}
...
export function BicycleCostingOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BicycleCostingOptions {
    ...
    return {
        ...
        'cyclingSpeed': json['cycling_speed'] == null ? undefined : json['cycling_speed'],
        'useRoads': json['use_roads'] == null ? undefined : json['use_roads'],
        'useHills': json['use_hills'] == null ? undefined : json['use_hills'],
        'avoidBadSurfaces': json['avoid_bad_surfaces'] == null ? undefined : json['avoid_bad_surfaces'],
        'bssReturnCost': json['bss_return_cost'] == null ? undefined : json['bss_return_cost'],
        'bssReturnPenalty': json['bss_return_penalty'] == null ? undefined : json['bss_return_penalty'],
    };
}
