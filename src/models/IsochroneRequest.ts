 ...
 */
export function instanceOfIsochroneRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "locations" in value;
    isInstance = isInstance && "costing" in value;
    isInstance = isInstance && "contours" in value;
...
export function IsochroneRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): IsochroneRequest {
    ...
    return {
        ...
        'polygons': !exists(json, 'polygons') ? undefined : json['polygons'],
        'denoise': !exists(json, 'denoise') ? undefined : json['denoise'],
        'generalize': !exists(json, 'generalize') ? undefined : json['generalize'],
        'showLocations': !exists(json, 'show_locations') ? undefined : json['show_locations'],
    };
}
