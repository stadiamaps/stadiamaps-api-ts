 ...
 * 
 * @export
 * @interface BaseTraceRequestAllOf
 */
export interface BaseTraceRequestAllOf {
    /**
     * An identifier to disambiguate requests (echoed by the server).
     * @type {string}
     * @memberof BaseTraceRequestAllOf
     */
    id?: string;
    /**
     ...
     * @memberof BaseTraceRequestAllOf
     */
    shapeMatch?: BaseTraceRequestAllOfShapeMatchEnum;
}
 ...
 * @export
 */
export const BaseTraceRequestAllOfShapeMatchEnum = {
    EdgeWalk: 'edge_walk',
    MapSnap: 'map_snap',
    WalkOrSnap: 'walk_or_snap'
} as const;
export type BaseTraceRequestAllOfShapeMatchEnum = typeof BaseTraceRequestAllOfShapeMatchEnum[keyof typeof BaseTraceRequestAllOfShapeMatchEnum];


/**
 * Check if a given object implements the BaseTraceRequestAllOf interface.
 */
export function instanceOfBaseTraceRequestAllOf(value: object): boolean {
    let isInstance = true;
...
export function BaseTraceRequestAllOfFromJSON(json: any): BaseTraceRequestAllOf {
    return BaseTraceRequestAllOfFromJSONTyped(json, false);
}

export function BaseTraceRequestAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseTraceRequestAllOf {
...
export function BaseTraceRequestAllOfToJSON(value?: BaseTraceRequestAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
